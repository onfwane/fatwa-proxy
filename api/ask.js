    ...
    const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "أنت مساعد شرعي ذكي. أجب عن الأسئلة الشرعية فقط باللغة العربية الفصحى بدقة ووضوح، استنادًا للقرآن الكريم والسنة النبوية وآراء العلماء الموثوقين. لا ترد بأي لغة أو رموز أجنبية."
          },
          {
            role: "user",
            content: question
